                                        ...
                                        <c:forEach begin="0" end="2" var="i">
                                            <div class="card bg-inverse text-white ${ i == 1 ? 'ml-2 mr-2' : '' }">
                                                ...
                                                <img class="img-fluid w-100 h-100"
                                                     src="<c:url value="/resources/uploads/${categoryArticle.value.get(i).imagePath}"/>">

                                                <div style="background-color: rgba(0, 0, 0, 0.4);"
                                                     class="card-img-overlay h-100 w-100 d-flex flex-column justify-content-end">
                                                    <h4 class="card-title">
                                                        <a href="<c:url value="/article"><c:param name="articleId" value="${ categoryArticle.value.get(i).id }" /></c:url>"
                                                           class="text-white">${ categoryArticle.value.get(i).title }</a>
                                                    </h4>
                                                    <p class="card-text">
                                    ...
                                    <c:if test="${ categoryArticle.value.size() == 6 }">
                                        <c:forEach begin="3" end="5" var="i">
                                            <div class="card bg-inverse text-white ${ i == 4 ? 'ml-2 mr-2' : '' }">
                                                <a href="#">
                                                    <img class="img-fluid w-100 h-100" id="articleImage" title="${categoryArticle.value.get(i).title}"
                                                         src="<c:url value="/resources/uploads/${categoryArticle.value.get(i).imagePath}"/>">
                                                </a>
                                                <div style="background-color: rgba(0, 0, 0, 0.4);"
