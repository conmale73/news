    ...
    <div class="row mt-3">
        ...
        <div class="col-md-12">
            ...
            <div class="text-center py-3">
                ...
                <figure class="figure">
                    <img src="<c:url value="/resources/uploads/${article.imagePath}"/>" class="figure-img img-fluid my-2"
                         alt="...">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action='<c:url value="/comments/do/add"/>' method="POST">
                                ...
                                <input class="form-control form-group" type="text" name="commentAuthor"
                                       placeholder="Name...">
                                <textarea name="commentContent" class="form-control" placeholder="Write a comment..."
                                          rows="3"></textarea>
                                <br>
                                <button name="addCommentSubmit" type="submit" class="btn btn-info pull-right">Post
                                </button>
                            </form>
